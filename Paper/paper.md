...
> **Outcome of the attempt.** The study did not establish the hoped-for broad,
> reliable benefit for LoRA rank allocation. We retain the valid restricted
> findings, null and negative results, and corrections as a public record of
> what was attempted and where it fell short. This is not an impossibility
> result for gradient-based allocation.
